...
public class BanPlayerDao {
    ...
    public static List<BanPlayerData> getAll() {
        ...
        try (Connection conn = DatabaseProvider.getConnection();
            ...
            LogWriter.writeError("[GreetingPlugin] BAN情報の取得に失敗しました。", e);
            return result;
        }
    ...
    public static void insert(BanPlayerData ban) {
        ...
        try (Connection conn = DatabaseProvider.getConnection();
            ...
            LogWriter.writeInfo("[GreetingPlugin] BANプレイヤーを登録: " + ban.getPlayerName());
        } catch (CriticalException e) {
            ErrorHandler.handleCriticalError(Main.getInstance(), e.getMessage(), e);
            return;
        } catch (SQLException e) {
            LogWriter.writeError("[GreetingPlugin] BANプレイヤーの登録に失敗しました。", e);
            return;
        }
    ...
    public static boolean delete(UUID uuid) {
        ...
        try (Connection conn = DatabaseProvider.getConnection();
            ...
            LogWriter.writeError("[GreetingPlugin] BANプレイヤーの削除に失敗しました。", e);
            return false;
        }
    }
