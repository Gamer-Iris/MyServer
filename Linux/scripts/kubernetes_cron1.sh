...
# GitHub関連設定
BRANCH_NAME="branch"
COMMIT_COMMENT="$(date '+%Y/%m/%d') targetRevisionの更新を反映"
...
#*****************************************************************************************************************************************************
    "STEP030")
      ...
      # EXEC------------------------------------------------------------------------------------------------------------------------------------------
      RESULT=$(ARGOCD_SERVER_ADDRESS=$(kubectl get svc argocd-server -n argocd -o jsonpath='{.status.loadBalancer.ingress[0].ip}') && \
...
#*****************************************************************************************************************************************************
    "STEP060")
      ...
      # EXEC------------------------------------------------------------------------------------------------------------------------------------------
      RESULT=$(sed -i "s/^\(\s*targetRevision:\s*\)${WORKING_VERSION}/\1${LATEST_VERSION}/" ~/MyServer/Linux/kubernetes/argo-cd-apps-deployment2.yml && \
...
#*****************************************************************************************************************************************************
    "STEP090")
      ...
      # EXEC------------------------------------------------------------------------------------------------------------------------------------------
      RESULT=$(sed -i "s/^\(\s*targetRevision:\s*\)${WORKING_VERSION}/\1${LATEST_VERSION}/" ~/MyServer/Linux/kubernetes/argo-cd-apps-deployment4.yml && \
...
#*****************************************************************************************************************************************************
    "STEP100")
      ...
      # EXEC------------------------------------------------------------------------------------------------------------------------------------------
      RESULT=$(if [[ ${COMMIT_FLG} -eq 1 ]]; then
                 cd ~/MyServer && \
