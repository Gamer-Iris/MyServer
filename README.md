...
【各secret設定】
各secret.ymlを編集
for app in cloudflare mariadb-phpmyadmin wordpress; do
...
```
ls -l /mnt/share/kubernetes/minecraft/proxy/config.yml
ls -l /mnt/share/kubernetes/minecraft/server1/spigot.yml
ls -l /mnt/share/kubernetes/minecraft/server2/spigot.yml
...
ls -l /mnt/share/kubernetes/minecraft/server1/plugins/BlueMap/core.conf
ls -l /mnt/share/kubernetes/minecraft/server2/plugins/BlueMap/core.conf
ls -l /mnt/share/kubernetes/minecraft/server1/plugins/BlueMap/maps/*.conf
ls -l /mnt/share/kubernetes/minecraft/server2/plugins/BlueMap/maps/*.conf
ls -l /mnt/share/kubernetes/minecraft/server1/plugins/BlueMap/storages/sql.conf
ls -l /mnt/share/kubernetes/minecraft/server2/plugins/BlueMap/storages/sql.conf
ls -l /mnt/share/kubernetes/minecraft/server1/plugins/Chunky/config.yml
ls -l /mnt/share/kubernetes/minecraft/server2/plugins/Chunky/config.yml
ls -l /mnt/share/kubernetes/minecraft/proxy/plugins/LuckPerms/config.yml
ls -l /mnt/share/kubernetes/minecraft/server1/plugins/LuckPerms/config.yml
ls -l /mnt/share/kubernetes/minecraft/server2/plugins/LuckPerms/config.yml
ls -l /mnt/share/kubernetes/minecraft/server1/plugins/LunaChat/config.yml
ls -l /mnt/share/kubernetes/minecraft/server2/plugins/LunaChat/config.yml
~/MyServer/Linux/scripts/minecraft_stop.sh
~/MyServer/Linux/scripts/minecraft_conversion2.sh

【BlueMap】
cd /mnt/share/kubernetes/minecraft/server1/plugins/BlueMap
diff core.conf_bk core.conf
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server2/plugins/BlueMap
diff core.conf_bk core.conf
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server1/plugins/BlueMap/maps
...
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server2/plugins/BlueMap/maps
diff バージョン番号.conf_bk バージョン番号.conf
（差分が期待した内容かを確認）
diff バージョン番号_nether.conf_bk バージョン番号_nether.conf
（差分が期待した内容かを確認）
diff バージョン番号_the_end.conf_bk バージョン番号_the_end.conf
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server1/plugins/BlueMap/storages
diff sql.conf_bk sql.conf
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server2/plugins/BlueMap/storages
diff sql.conf_bk sql.conf
（差分が期待した内容かを確認）

【Chunky】
cd /mnt/share/kubernetes/minecraft/server1/plugins/Chunky
diff config.yml_bk config.yml
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server2/plugins/Chunky
diff config.yml_bk config.yml
（差分が期待した内容かを確認）

【LuckPerms】
cd /mnt/share/kubernetes/minecraft/proxy/plugins/LuckPerms
diff config.yml_bk config.yml
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server1/plugins/LuckPerms
diff config.yml_bk config.yml
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server2/plugins/LuckPerms
diff config.yml_bk config.yml
（差分が期待した内容かを確認）

【LunaChat】
cd /mnt/share/kubernetes/minecraft/server1/plugins/LunaChat
diff config.yml_bk config.yml
（差分が期待した内容かを確認）
cd /mnt/share/kubernetes/minecraft/server2/plugins/LunaChat
diff config.yml_bk config.yml
（差分が期待した内容かを確認）
