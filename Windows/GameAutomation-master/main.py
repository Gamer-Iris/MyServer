...
from GameAutomation import GameAutomation # type: ignore
...
# ログディレクトリとファイルの存在確認と作成
log_dir = 'logs'
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
open(os.path.join(log_dir, 'result.log'), 'a').close()
...
## ハンドラー設定
handler = FileHandler('logs/result.log')
...
try:
    ...
    if __name__ == "__main__":
        ...
        # FF14内容
            ...
            from ff14_main import ff14_main # type: ignore
        ...
        # FGO内容
            ...
            from fgo_main import fgo_main # type: ignore
